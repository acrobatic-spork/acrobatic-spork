...
describe('the FourSquare Controller', function (done) {
  it('should have all the functions', function () {
    ...
    expect(FourSquare.callUberAsync).to.be.a('function');
  });
  ...
  it('should request an uber car', function () {
    var userObj = {
      section: 'food',
      radius: '4828',
      price: '2',
    ...
    return FourSquare.callUberAsync(testVenue)
    .then(function (response) {
      expect(response.body.body.status).to.equal('processing');
    });
  });
