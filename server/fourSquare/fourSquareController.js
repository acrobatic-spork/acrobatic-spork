...
module.exports = function (req, res, next) {
  request.get('/api/users?username=' + req.params.username)
    ...
    .then(function (query) {
      request.get('https://api.foursquare.com/v2/venues/explore?ll='+query.lat+','+query.lng'&section='+query.section+'&openNow=1&limit=10&client_id='+config.client_id+'&client_secret='+config.client_secret+'&v=20160223', function (err, response) {
